...
Founder OS is built in the open. This is where we're headed — priorities shift
based on community input, so open a [Discussion](https://github.com/aadhib/founder-os-for-claude/discussions)
...
- More integrations: Windsurf, Zed, JetBrains AI
...
- Eval harness scoring skill output quality across model versions
- Skill regression tests on model upgrades
- Localization of skill docs

## Out of scope (for now)

- Hosted SaaS — Founder OS stays local-first and free
- Closed-source skills — everything ships MIT
